...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.last_online'
        db.add_column(u'phone_auth_user', 'last_online',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.last_online'
        db.delete_column(u'phone_auth_user', 'last_online')
    ...
    models = {
        ...
        u'phone_auth.anonymousphonenumber': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0073.jpg'", 'max_length': '128'}),
