...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.user_glance_score'
        db.add_column(u'phone_auth_user', 'user_glance_score',
                      self.gf('django.db.models.fields.IntegerField')(default=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.user_glance_score'
        db.delete_column(u'phone_auth_user', 'user_glance_score')
    ...
    models = {
        ...
        u'phone_auth.anonymousphonenumber': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0029.jpg'", 'max_length': '128'}),
