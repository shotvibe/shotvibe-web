...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoGlance'
        db.create_table(u'photos_photoglance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'])),
            ('emoticon_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'photos', ['PhotoGlance'])

        # Adding unique constraint on 'PhotoGlance', fields ['photo', 'author']
        db.create_unique(u'photos_photoglance', ['photo_id', 'author_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PhotoGlance', fields ['photo', 'author']
        db.delete_unique(u'photos_photoglance', ['photo_id', 'author_id'])

        # Deleting model 'PhotoGlance'
        db.delete_table(u'photos_photoglance')
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0015.jpg'", 'max_length': '128'}),
