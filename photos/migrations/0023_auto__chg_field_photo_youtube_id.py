...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.youtube_id'
        db.alter_column(u'photos_photo', 'youtube_id', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Photo.youtube_id'
        db.alter_column(u'photos_photo', 'youtube_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    models = {
        ...
        u'photos.photo': {
            ...
            'youtube_id': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '64'})
        },
