...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoGlanceScoreDelta'
        db.create_table(u'photos_photoglancescoredelta', (
            ...
            ('score_delta', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'photos', ['PhotoGlanceScoreDelta'])

        # Adding unique constraint on 'PhotoGlanceScoreDelta', fields ['photo', 'author']
        db.create_unique(u'photos_photoglancescoredelta', ['photo_id', 'author_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PhotoGlanceScoreDelta', fields ['photo', 'author']
        db.delete_unique(u'photos_photoglancescoredelta', ['photo_id', 'author_id'])

        # Deleting model 'PhotoGlanceScoreDelta'
        db.delete_table(u'photos_photoglancescoredelta')
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0078.jpg'", 'max_length': '128'}),
