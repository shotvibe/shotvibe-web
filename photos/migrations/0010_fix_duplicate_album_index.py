...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for album in orm.Album.objects.all():
            i = 0
            for photo in orm.Photo.objects.filter(album=album).order_by('album_index'):
                if photo.album_index != i:
                    photo.album_index = i
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0006.jpg'", 'max_length': '128'}),
