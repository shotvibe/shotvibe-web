...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoServer'
        db.create_table(u'photos_photoserver', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photos_update_url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('subdomain', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('auth_key', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('date_registered', self.gf('django.db.models.fields.DateTimeField')()),
            ('unreachable', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'photos', ['PhotoServer'])


    def backwards(self, orm):
        # Deleting model 'PhotoServer'
        db.delete_table(u'photos_photoserver')
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0060.jpg'", 'max_length': '128'}),
