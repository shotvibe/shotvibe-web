...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Photo', fields ['album', 'album_index']
        db.create_unique(u'photos_photo', ['album_id', 'album_index'])


    def backwards(self, orm):
        # Removing unique constraint on 'Photo', fields ['album', 'album_index']
        db.delete_unique(u'photos_photo', ['album_id', 'album_index'])
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0050.jpg'", 'max_length': '128'}),
