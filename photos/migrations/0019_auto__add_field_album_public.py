...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'photos_album', 'public',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'photos_album', 'public')
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0021.jpg'", 'max_length': '128'}),
