...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.photo_glance_score'
        db.add_column(u'photos_photo', 'photo_glance_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Photo.copied_from_photo'
        db.add_column(u'photos_photo', 'copied_from_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.photo_glance_score'
        db.delete_column(u'photos_photo', 'photo_glance_score')

        # Deleting field 'Photo.copied_from_photo'
        db.delete_column(u'photos_photo', 'copied_from_photo_id')
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0026.jpg'", 'max_length': '128'}),
