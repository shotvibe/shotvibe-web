...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Album.name'
        db.delete_column(u'photos_album', 'name')


    def backwards(self, orm):
        # Adding field 'Album.name'
        db.add_column(u'photos_album', 'name',
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0041.jpg'", 'max_length': '128'}),
        ...
        u'photos.pendingphoto': {
            ...
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'234dc0fff00af908acd6caa5bece8124d4cebaf476fd4e33c822d2d00657e941'", 'max_length': '128', 'primary_key': 'True'}),
