...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumMember.album_admin'
        db.add_column('photos_album_members', 'album_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumMember.album_admin'
        db.delete_column('photos_album_members', 'album_admin')
