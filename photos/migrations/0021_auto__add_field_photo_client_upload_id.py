...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.client_upload_id'
        db.add_column(u'photos_photo', 'client_upload_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.client_upload_id'
        db.delete_column(u'photos_photo', 'client_upload_id')
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0058.jpg'", 'max_length': '128'}),
