...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoUserTag'
        db.create_table(u'photos_photousertag', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['phone_auth.User'])),
            ('tagged_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phone_auth.User'])),
            ('tag_coord_x', self.gf('django.db.models.fields.FloatField')()),
            ('tag_coord_y', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'photos', ['PhotoUserTag'])

        # Adding unique constraint on 'PhotoUserTag', fields ['photo', 'tagged_user']
        db.create_unique(u'photos_photousertag', ['photo_id', 'tagged_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PhotoUserTag', fields ['photo', 'tagged_user']
        db.delete_unique(u'photos_photousertag', ['photo_id', 'tagged_user_id'])

        # Deleting model 'PhotoUserTag'
        db.delete_table(u'photos_photousertag')
