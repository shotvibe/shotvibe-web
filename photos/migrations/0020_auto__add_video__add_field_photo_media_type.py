...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Video'
        db.create_table(u'photos_video', (
            ('storage_id', self.gf('django.db.models.fields.CharField')(max_length=128, primary_key=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'photos', ['Video'])

        # Adding field 'Photo.media_type'
        db.add_column(u'photos_photo', 'media_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'photos_video')

        # Deleting field 'Photo.media_type'
        db.delete_column(u'photos_photo', 'media_type')
