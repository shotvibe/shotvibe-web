...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'photos_photocomment', (
            ...
            ('client_msg_id', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
            ('comment_text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'photos', ['PhotoComment'])

        # Adding unique constraint on 'PhotoComment', fields ['photo', 'author', 'client_msg_id']
        db.create_unique(u'photos_photocomment', ['photo_id', 'author_id', 'client_msg_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PhotoComment', fields ['photo', 'author', 'client_msg_id']
        db.delete_unique(u'photos_photocomment', ['photo_id', 'author_id', 'client_msg_id'])

        # Deleting model 'PhotoComment'
        db.delete_table(u'photos_photocomment')
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0011.jpg'", 'max_length': '128'}),
