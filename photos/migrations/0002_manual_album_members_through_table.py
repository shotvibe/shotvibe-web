...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('photos_album_members', 'added_by_member_id', models.IntegerField(default=None, null=True, blank=True), keep_default=False)
        db.add_column('photos_album_members', 'datetime_added', models.DateTimeField(default=timezone.now()), keep_default=False)

    def backwards(self, orm):
        db.delete_column('photos_album_members', 'added_by_member_id')
