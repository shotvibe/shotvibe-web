...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumMember.added_by_user'
        db.add_column('photos_album_members', 'added_by_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='created_album_memberships', to=orm['phone_auth.User']),
                      keep_default=False)

        # Adding field 'AlbumMember.datetime_added'
        db.add_column('photos_album_members', 'datetime_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=timezone.now()),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'AlbumMember.added_by_user'
        db.delete_column('photos_album_members', 'added_by_user_id')

        # Deleting field 'AlbumMember.datetime_added'
        db.delete_column('photos_album_members', 'datetime_added')
