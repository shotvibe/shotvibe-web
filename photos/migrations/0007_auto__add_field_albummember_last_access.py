...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumMember.last_access'
        db.add_column('photos_album_members', 'last_access',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumMember.last_access'
        db.delete_column('photos_album_members', 'last_access')
    ...
    models = {
        ...
        u'photos.pendingphoto': {
            ...
            'photo_id': ('django.db.models.fields.CharField', [], {'default': "'6491d947b5fda792fbe74e121a2146c71dbf7aaef6881d873dad8842e1c63969'", 'max_length': '128', 'primary_key': 'True'}),
