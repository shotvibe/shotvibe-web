...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.youtube_id'
        db.add_column(u'photos_photo', 'youtube_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.youtube_id'
        db.delete_column(u'photos_photo', 'youtube_id')
    ...
    models = {
        ...
        u'photos.photo': {
            ...
            'youtube_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64', 'null': 'True'})
        },
