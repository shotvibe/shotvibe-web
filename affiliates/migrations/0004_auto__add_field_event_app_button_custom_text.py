...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.app_button_custom_text'
        db.add_column(u'affiliates_event', 'app_button_custom_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.app_button_custom_text'
        db.delete_column(u'affiliates_event', 'app_button_custom_text')
    ...
    models = {
        u'affiliates.event': {
            ...
            'app_button_custom_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'sms_message': ('django.db.models.fields.TextField', [], {}),
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0028.jpg'", 'max_length': '128'}),
