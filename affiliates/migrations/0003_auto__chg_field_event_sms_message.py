...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.sms_message'
        db.alter_column(u'affiliates_event', 'sms_message', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Event.sms_message'
        db.alter_column(u'affiliates_event', 'sms_message', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'phone_auth.user': {
            ...
            'avatar_file': ('django.db.models.fields.CharField', [], {'default': "'s3:shotvibe-avatars-01:default-avatar-0018.jpg'", 'max_length': '128'}),
